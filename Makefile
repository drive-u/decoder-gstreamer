CC = g++
CFLAGS = -Wall -Wextra -pedantic -std=c++11 -std=c++2a -I../interface -I/usr/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
